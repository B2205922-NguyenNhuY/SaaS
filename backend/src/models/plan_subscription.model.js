...
exports.createSubscription = async (connection, data) => {
    ...
    const [result] = await connection.execute(
        ...
        VALUES (?, ?, NULL, 'pending', NOW(), DATE_ADD(NOW(), INTERVAL 1 YEAR))`,
        [plan_id, tenant_id]
    );
...
//Cập nhật stripe_subscription_id
...
exports.extendSubscription = async (connection, subscription_id) => {
    ...
    await connection.execute(
        `UPDATE plan_subscription
         ...
         ngayKetThuc = DATE_ADD(ngayKetThuc, INTERVAL 1 MONTH)
